...
**→ [Browse the docs on GitHub](https://github.com/hirasso/focal-point-picker)**

== Changelog ==

**→ [View the changelog on GitHub](https://github.com/hirasso/focal-point-picker/blob/main/CHANGELOG.md)**